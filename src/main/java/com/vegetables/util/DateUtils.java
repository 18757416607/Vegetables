...
public class DateUtils {
     ...
     * @return
     */
    public static String getOneBehandMonth() {
    ...
    /**
     * Date 格式 字符串日期 转换  yyyy-MM-dd HH:mm:ss
     *
     * @return
     */
    ...
    public static String getHHMMSS() throws Exception{
        ...
        str.append(now.get(Calendar.HOUR_OF_DAY)).append(":")
     ...
     * @throws Exception
     */
    public static Map<String,Integer> getSplitDate() throws Exception{
        Calendar now = Calendar.getInstance();
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(getSplitDate());
    }
